...
import { userToken, bookmarkArticle, getBookmarkId, userTokenThree, deleteBookmarkId } from './helper/testData';
			...
			request(app)
				...
				.end((err, res) => {
					expect(res.body)
						...
						.to.eql('the article has been removed from bookmark successfully');
					if (err) return done(err);
					done();
				});
		});
